...
import be.pxl.emailservice.sparkpost.dto.SparkPostRequest;
...
public class SparkPostStub implements Stub {
    ...
    private final Map<String, List<SparkPostRequest>> receivedEmailRequests = new HashMap<>();
    ...
    public List<SparkPostRequest> getReceivedEmailRequests(String emailAdres) {
